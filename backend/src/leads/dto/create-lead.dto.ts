...
export class CreateLeadDto {
    ...
    @IsArray() @IsOptional() primaryContactRoles?: string[];
    @IsObject() @IsOptional() sectionNotes?: Record<string, string>;
    @IsObject() @IsOptional() sectionCustomFields?: Record<string, unknown[]>;
