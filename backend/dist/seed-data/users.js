...
exports.DEFAULT_ROLES = [
    ...
    },
    {
        ...
        tier: 'internal', order: 7, isSystem: false,
        permissions: perms(['dashboard', 'projects', 'tasks', 'design', 'selections', 'planroom', 'schedule', 'rfis', 'changeorders', 'library'], ['design', 'tasks', 'rfis']),
    },
    {
        key: 'drafting', name: 'Drafting', description: 'Drawing production and renderings.',
        tier: 'internal', order: 8, isSystem: false,
        permissions: perms(['dashboard', 'projects', 'tasks', 'design', 'planroom', 'library'], ['design']),
    },
    {
        key: 'accounting', name: 'Accounting', description: 'Invoicing, payments and project finance.',
        tier: 'internal', order: 9, isSystem: false,
        permissions: perms(['dashboard', 'projects', 'tasks', 'reimbursement', 'library', 'reports', 'fin_business', 'fin_project', 'fin_resources'], ['reimbursement', 'fin_project', 'fin_business', 'fin_resources']),
    },
    {
        ...
        permissions: perms(['dashboard', 'projects', 'tasks', 'design', 'planroom', 'schedule', 'quality', 'library'], ['tasks', 'planroom']),
    },
    {
        ...
        permissions: perms(['dashboard', 'projects', 'tasks', 'design', 'selections', 'planroom', 'library'], ['selections', 'design']),
    },
    {
        ...
        permissions: perms(['dashboard', 'projects', 'tasks', 'pm', 'quality', 'schedule', 'rfis', 'changeorders', 'manpower_con', 'planroom', 'library'], ['pm', 'quality', 'tasks']),
    },
    {
