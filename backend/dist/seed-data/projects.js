...
exports.WF_ST_COLORS = exports.TEAM_BGS = exports.TEAM_COLORS = exports.PROJECT_WORKFLOW = exports.PR_COLORS = exports.STAGE_CONFIG = exports.PROJECTS = void 0;
exports.computeWorkflow = computeWorkflow;
exports.PROJECTS = [
...
exports.TEAM_COLORS = { 'Project Management': '#173326', 'Admin & Coordination': '#245C3A', Architecture: '#2F6F68', Design: '#2F6F68', Interiors: '#D2822E', 'Permits & Compliance': '#8E2E0A', Finance: '#2F7D4A', 'Legal & Contracts': '#0F2417', 'Client / Owner': '#0B1A12', Automation: '#D2822E', 'Field Operations': '#1C5230' };
exports.TEAM_BGS = { 'Project Management': '#DCE7DE', 'Admin & Coordination': '#EEF3EE', Architecture: '#D6E8E5', Design: '#D3EAE6', Interiors: '#FBE9AE', 'Permits & Compliance': '#F2DFD4', Finance: '#D2EAD3', 'Legal & Contracts': '#DCE7DE', 'Client / Owner': '#EFEDE8', Automation: '#FBE9AE', 'Field Operations': '#D2EAD3' };
exports.WF_ST_COLORS = { Done: { bg: '#D2EAD3', c: '#1C5230' }, Open: { bg: '#EFEDE8', c: '#3A423E' }, 'In Progress': { bg: '#D6E8E5', c: '#2F6F68' } };
function computeWorkflow() {
    let prevComplete = true;
    return exports.PROJECT_WORKFLOW.map((ph, idx) => {
