...
const email_templates_1 = require("../auth/email.templates");
const row = (t, accent) => `
  <tr>
    <td style="padding:9px 0;border-bottom:1px solid rgba(20,8,31,0.06);">
      <div style="font-size:13.5px;font-weight:600;color:#0B1A12;">${(0, email_templates_1.escapeHtml)(t.title)}</div>
      <div style="font-size:11.5px;color:#7E9B93;margin-top:2px;">
        ${(0, email_templates_1.escapeHtml)(t.project || 'No project')} ·
        <span style="color:${accent};font-weight:600;">${(0, email_templates_1.escapeHtml)(t.dueDate)}</span>
      </div>
    </td>
  </tr>`;
      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:14px;border:1px solid rgba(20,8,31,0.08);overflow:hidden;">
          ...
          <tr><td style="padding:28px 28px 4px;">
            <h1 style="margin:0 0 6px;font-size:20px;line-height:1.3;color:#0B1A12;font-weight:700;">Morning, ${(0, email_templates_1.escapeHtml)(first)}</h1>
            <p style="margin:0 0 22px;font-size:13.5px;line-height:1.6;color:#43514D;">${(0, email_templates_1.escapeHtml)(headline)}.</p>
