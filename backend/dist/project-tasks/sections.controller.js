...
let SectionsController = class SectionsController {
    ...
    async remove(id) {
        ...
        if (section) {
            ...
            if (siblings.length)
                await this.tasks.reparentTasks(id, siblings[0].id);
            else
                await this.tasks.deleteTasksInSection(id);
        }
...
exports.SectionsController = SectionsController = __decorate([
    (0, common_1.Controller)('project-sections'),
