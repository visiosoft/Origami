...
let EmailTemplatesService = class EmailTemplatesService {
    ...
    async onApplicationBootstrap() {
        try {
            ...
            const legacyIntroBodies = [email_templates_1.LEGACY_INTRODUCTION_LETTER_BODY_V1, email_templates_1.LEGACY_INTRODUCTION_LETTER_BODY_V2, email_templates_1.LEGACY_INTRODUCTION_LETTER_BODY_V3];
